...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                     <?php $__env->slot('trigger', null, []); ?> 
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                            <div x-data="<?php echo e(json_encode(['name' => auth()->user()?->name ?? 'Guest'])); ?>" 
                                 x-text="name" 
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                <div class="font-medium text-base text-gray-800" 
                     x-data="<?php echo e(json_encode(['name' => auth()->user()?->name ?? 'Guest'])); ?>" 
                     x-text="name" 
                     x-on:profile-updated.window="name = $event.detail.name">
                </div>
                <div class="font-medium text-sm text-gray-500">
                    <?php echo e(auth()->user()?->email ?? 'No email available'); ?>
...
</nav><?php /**PATH D:\SEMESTER 3\Pemrograman Berbasis Web 2\Program\task-manager\resources\views\livewire/layout/navigation.blade.php ENDPATH**/ ?>